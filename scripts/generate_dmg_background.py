#!/usr/bin/env python3
"""
Generate DMG background images for Imla installer.
Produces:
...
# ---------------------------------------------------------------------------
# Colour palette (Imla Design System)
# ---------------------------------------------------------------------------
...
RENDER_SCALE = 4
APP_DISPLAY_NAME = os.environ.get("MUESLI_DMG_APP_NAME", "Imla")
...
def draw_arrow(canvas: Image.Image, S: int):
    """
    Directional cubic Bézier arrow from Imla box to Applications box.
...
def generate():
    ...
    icon_path = os.path.normpath(os.path.join(script_dir, "assets", "imla_app_icon.png"))
