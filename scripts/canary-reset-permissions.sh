...
#   ./scripts/canary-reset-permissions.sh --bundle-id com.xshaheen.imla.canary
#   ./scripts/canary-reset-permissions.sh --dry-run

BUNDLE_ID="${MUESLI_CANARY_BUNDLE_ID:-com.xshaheen.imla.canary}"
APP_PROCESS_NAME="${MUESLI_CANARY_PROCESS_NAME:-ImlaCanary}"
DRY_RUN=0
FORCE=0
