...
Source: strings and Swift metadata of the locally installed `/Applications/Monologue.app` (bundle `com.zeitalabs.jottleai`, 1.4.2). No code was executed or decompiled; these are type/field names, log strings and UI copy. Used as a behavioural benchmark for the Imla Dictation Mini, not as an asset source.
