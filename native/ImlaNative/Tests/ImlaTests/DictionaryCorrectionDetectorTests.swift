...
struct DictionaryCorrectionDetectorTests {
    ...
    func detectsImlaCorrectionFromLatestFailureShape() {
    ...
    func detectsImlaCorrectionFromLatestMusleyFailure() {
    ...
    func detectsImlaCorrectionFromLatestMuwslyFailure() {
    ...
    func detectsFinalEditedTranscriptSnapshot() {
        let suggestion = DictionaryCorrectionDetector.suggestion(
            ...
            editedText: "Hey Imla, can you see if you're transcribing the word correctly?"
        )

        #expect(suggestion?.observed == "Musley")
        #expect(suggestion?.replacement == "Imla")
    }
...
struct DictionarySuggestionConfigTests {
    ...
    func stableSuggestionKey() {
        #expect(
            DictionarySuggestion.key(observed: " Museli ", replacement: "Imla")
