...
struct AccentSelectionTests {
    ...
    func emptyConfigUsesDefault() throws {
        ...
        #expect(ImlaTheme.resolvedAccentDarkHex(overrideHex: config.accentOverrideHex)
    ...
    func defaultAccentIsCoral() {
        ...
        #expect(ImlaTheme.defaultAccentDarkHex == DictationMiniPalette.accentHex)
    }
    ...
    func darkSurvivesOnceMigrated() throws {
        ...
        #expect(ImlaTheme.resolvedAccentDarkHex(overrideHex: config.accentOverrideHex) == 0x1E1E2E)
    }
    ...
    func presetResolvesToItself() throws {
        ...
        #expect(ImlaTheme.resolvedAccentDarkHex(overrideHex: config.accentOverrideHex) == 0x8B5CF6)
    }
