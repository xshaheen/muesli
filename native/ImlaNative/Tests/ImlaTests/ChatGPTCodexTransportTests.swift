...
struct ChatGPTResponsesTransportTests {
    ...
    @Test("builds Codex Responses requests with honest Imla identity")
    func buildsCodexRequest() throws {
        ...
        #expect(request.value(forHTTPHeaderField: "originator") == "imla")
        #expect(request.value(forHTTPHeaderField: "version") == nil)
        #expect(request.value(forHTTPHeaderField: "User-Agent") == "Imla/1.2.3")
