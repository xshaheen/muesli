...
struct ContributionMilestoneTests {
    ...
    func promptEligibility() {
        ...
        #expect(prompt?.showTweetAboutImla == false)
    ...
    func remainingActions() {
        ...
        #expect(wordPrompt?.showTweetAboutImla == true)
    ...
    func socialActionsRequireSupportAction() {
        ...
        #expect(socialPrompt?.showTweetAboutImla == true)
    ...
    func shareMessageAndURLs() throws {
        ...
        #expect(message == "I've dictated 31,000 words with Imla. It's fast, open source, on-device, and free to use. Try it: https://github.com/xshaheen/muesli")
        ...
        #expect(queryItems["url"] == "https://github.com/xshaheen/muesli")
        #expect(queryItems["shareUrl"] == "https://github.com/xshaheen/muesli")
