...
struct AccessibilityPermissionGuideTests {
    ...
    @Test("an accepted drop attempt does not claim that Imla was added")
    func attemptedDropCopyIsNonDefinitive() {
        #expect(AccessibilityPermissionGuideCopy.attemptedDropTitle(appName: "ImlaDevB") == "Turn ImlaDevB on")
    ...
    func suppressionPolicy() {
        let settingsBundleID = AccessibilityPermissionGuidePresentationPolicy.systemSettingsBundleID
        let imlaBundleID = "com.xshaheen.imla.dev.b"
        ...
        #expect(!AccessibilityPermissionGuideSuppressionPolicy.shouldSuppressOnboarding(
            isRequested: true,
            isGranted: false,
            frontmostBundleID: imlaBundleID,
            hasUsableGuide: true
        ))
        #expect(!AccessibilityPermissionGuideSuppressionPolicy.shouldSuppressOnboarding(
            isRequested: true,
