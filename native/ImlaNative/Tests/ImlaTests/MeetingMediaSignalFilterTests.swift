...
struct MeetingMediaSignalFilterTests {
    ...
    private let selfBundleID = "com.xshaheen.imla"
    ...
    func muesliDictationMicDoesNotSatisfyCalendarMeetingActivity() {
        let media = MeetingMediaSignalFilter.apply(
            ...
            cameraActive: false,
            audioInputProcesses: [
                audioProcess(bundleID: selfBundleID, appName: "Imla"),
            ],
    ...
    @Test("external meeting mic still counts when Imla is also using input")
    func externalMeetingMicStillCountsWhenImlaIsAlsoUsingInput() {
        let media = MeetingMediaSignalFilter.apply(
            deviceMicActive: true,
            cameraActive: false,
            audioInputProcesses: [
    ...
    func selfHelperAudioInputIsTreatedAsImla() {
        let media = MeetingMediaSignalFilter.apply(
            deviceMicActive: true,
            cameraActive: false,
            audioInputProcesses: [
                audioProcess(bundleID: "\(selfBundleID).helper", appName: "Imla Helper"),
            ],
            sensorAttributions: sensorAttributions(),
            selfBundleID: selfBundleID
        )
