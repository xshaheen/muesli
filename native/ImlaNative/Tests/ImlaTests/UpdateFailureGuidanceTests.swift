...
struct UpdateActionRoutingTests {
    ...
    func statusBarUpdateActionUsesStandardSparkleFlow() throws {
        ...
        """))
        #expect(statusBarSource.contains("#selector(ImlaController.checkForUpdates)"))
    ...
    func aboutPageUsesMenuBarGuidanceOnly() throws {
        ...
        #expect(!source.contains("let controller: ImlaController"))
    ...
    private func muesliControllerSource() throws -> String {
        ...
        let controllerURL = packageRoot
            ...
            .appendingPathComponent("ImlaController.swift")
...
struct SidebarHitAreaTests {
    ...
    func sidebarKeepsSecondaryControlsInSettings() throws {
        ...
        #expect(!sidebarSource.contains("Tweet about Imla"))
