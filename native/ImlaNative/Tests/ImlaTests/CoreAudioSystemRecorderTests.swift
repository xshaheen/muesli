...
struct CoreAudioSystemRecorderTests {
    ...
    @Test("global tap description captures process mix except Imla")
    func globalTapDescriptionExcludesSelfAudio() {
        let tapDescription = CoreAudioSystemRecorder.makeGlobalTapDescription(
            ...
            name: "Imla Global Test Tap"
        )

        #expect(tapDescription.name == "Imla Global Test Tap")
    ...
    func aggregateDeviceDescriptionIncludesTap() throws {
        ...
        #expect(description[kAudioAggregateDeviceNameKey] as? String == "Imla System Audio")
