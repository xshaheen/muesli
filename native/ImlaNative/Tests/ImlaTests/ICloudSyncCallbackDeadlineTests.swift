...
struct ICloudBridgeWorkingCopyTests {
    ...
    func syncQRCodeMatchesBuildLane() {
        #expect(IPhoneBridgeLinks.syncDeepLinkURL(bundleIdentifier: "com.xshaheen.imla.dev").scheme == "imladev")
        #expect(IPhoneBridgeLinks.syncDeepLinkURL(bundleIdentifier: "com.xshaheen.imla.dev.c").scheme == "imladev")
        #expect(IPhoneBridgeLinks.syncDeepLinkURL(bundleIdentifier: "com.xshaheen.imla").scheme == "imla")
    }
