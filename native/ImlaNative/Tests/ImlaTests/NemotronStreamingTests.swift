...
struct Nemotron35LanguageTests {
    ...
    func dictationDecisionIsSharedAcrossPaths() throws {
        ...
        let whisper = ImlaController.dictationLanguageDecision(
            profile: bilingual,
        ...
        let parakeet = ImlaController.dictationLanguageDecision(
            profile: bilingual,
        ...
        let automatic = ImlaController.dictationLanguageDecision(
            profile: .automatic,
