...
// `@Suite` declarations one level deep in `Tests/ImlaTests/`, so a suite parked here would evade
...
/// on `BackendOption` and the app pipeline, and `ImlaCore` stays Foundation-only. What crosses the
