...
enum Gemma4LiteRTModelStore {
    ...
    static let cacheRelativePath = ".cache/imla/models/\(Gemma4LiteRTModel.e2b.cacheDirectoryName)"
    ...
    * When transcribing numbers, write the digits, i.e. write 1.7 and not one point seven, and write 3 instead of three.
    ...
    static func cacheDirectory(
        ...
        fileManager.homeDirectoryForCurrentUser
            .appendingPathComponent(".cache/imla/models/\(model.cacheDirectoryName)", isDirectory: true)
    }
