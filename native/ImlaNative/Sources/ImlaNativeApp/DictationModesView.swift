...
struct DictationModesView: View {
    ...
    init(appState: AppState, controller: ImlaController, onClose: @escaping () -> Void) {
    ...
    private let columns = [
        GridItem(.flexible(), spacing: ImlaTheme.spacing12),
        GridItem(.flexible(), spacing: ImlaTheme.spacing12),
    ]
    ...
    private var header: some View {
        HStack(alignment: .firstTextBaseline) {
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text("Imla picks a mode from the app or website you dictate into.")
    ...
    private var modesSection: some View {
        LazyVGrid(columns: columns, alignment: .leading, spacing: ImlaTheme.spacing12) {
            ...
            HStack(spacing: 4) {
                ...
                ForEach(mode.websiteHostnames.prefix(2), id: \.self) { host in
                    Text(host)
                        ...
                        .clipShape(RoundedRectangle(cornerRadius: ImlaTheme.cornerChip, style: .continuous))
                }
