        ...
        HStack(spacing: ImlaTheme.spacing8) {
            if isDownloading {
                ...
                if !isActive {
                    ...
                    .buttonStyle(.plain)
                    .font(ImlaTheme.font(size: 12, weight: .medium))
                    .foregroundStyle(activationDisabledReason == nil ? ImlaTheme.accent : ImlaTheme.textTertiary)
                    .padding(.horizontal, ImlaTheme.spacing12)
                    .padding(.vertical, 4)
                    .background(activationDisabledReason == nil ? ImlaTheme.accentSubtle : ImlaTheme.surfacePrimary)
                    .clipShape(RoundedRectangle(cornerRadius: ImlaTheme.cornerSmall, style: .continuous))
