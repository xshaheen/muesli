...
private final class BoundedOutputBuffer {
    ...
    private let queue = DispatchQueue(label: "com.xshaheen.imla.meeting-hook-output-buffer")
...
final class MeetingHookRunner: MeetingHookDispatching {
    private static let logger = Logger(subsystem: "com.xshaheen.imla", category: "MeetingHook")
    private static let maxLoggedStandardErrorBytes = 4096

    private let supportDirectory: URL
    private let fileManager: FileManager
    private let logQueue = DispatchQueue(label: "com.xshaheen.imla.meeting-hook-log")
