...
final class StreamingDictationController {
    ...
    init(
        ...
        recorder: StreamingDictationRecording = FallbackStreamingDictationRecorder(
            primary: AudioQueueInputRecorder(directoryName: "imla-native-dictation-streaming"),
            fallback: StreamingMicRecorder(directoryName: "imla-native-dictation-streaming")
        ),
