    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: ImlaTheme.spacing20) {
                HStack(alignment: .top, spacing: ImlaTheme.spacing12) {
                    ...
                    VStack(alignment: .leading, spacing: 5) {
                        ...
                        Text("Want a quick tour of what’s new?")
                            .font(ImlaTheme.font(size: 21, weight: .bold))
                            .foregroundStyle(ImlaTheme.textPrimary)
                    }
                ...
                Text("See \(tour.steps.count) additions in the places where you’ll actually use them. You can replay this later from What’s New in Imla.")
                    .font(ImlaTheme.body())
                    .foregroundStyle(ImlaTheme.textSecondary)
                    .lineSpacing(2)
                    .fixedSize(horizontal: false, vertical: true)
