...
final class AppScopedDictationRecorder: DictationAudioRecording {
    ...
    init(
        recorder: StreamingDictationRecording = FallbackStreamingDictationRecorder(
            primary: AudioQueueInputRecorder(directoryName: "imla-native-dictation"),
            fallback: StreamingMicRecorder(directoryName: "imla-native-dictation")
        ),
        prepareQueue: DispatchQueue = DispatchQueue(label: "com.xshaheen.imla-scoped-dictation-recorder-prepare"),
        recorderQueue: DispatchQueue = DispatchQueue(label: "com.xshaheen.imla-scoped-dictation-recorder-child"),
        callbackQueue: DispatchQueue = DispatchQueue(label: "com.xshaheen.imla-scoped-dictation-recorder-callbacks")
    ) {
