...
struct DictionaryCorrectionDetector {
    ...
    private static let logger = Logger(subsystem: "com.xshaheen.imla", category: "DictionaryCorrection")
...
final class DictationCorrectionMonitor {
    nonisolated private static let logger = Logger(subsystem: "com.xshaheen.imla", category: "DictionaryCorrection")
