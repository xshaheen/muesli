...
final class SystemAudioRecorder: NSObject, SCStreamOutput, SCStreamDelegate, SystemAudioCapturing, SystemAudioDiagnosticsProviding {
    ...
    /// caller's thread.
    private let streamStateQueue = DispatchQueue(label: "com.xshaheen.imla.system-audio.stream-state")
    ...
    private let sampleHandlerQueue = DispatchQueue(label: "com.xshaheen.imla.system-audio")
