...
enum ImlaTelemetryChannel: String, CaseIterable, Sendable {
    case production
    case preprod
    case dev
    case canary
...
struct TelemetryRuntimeConfiguration: Equatable, Sendable {
    static let appIDInfoKey = "ImlaTelemetryDeckAppID"
    static let channelInfoKey = "ImlaTelemetryChannel"
    static let disabledSDKAppID = "00000000-0000-0000-0000-000000000000"

    let appID: String
    let channel: ImlaTelemetryChannel
    let bundleID: String
    let isEnabled: Bool
    ...
    static func resolve(
        ...
        let channel = ImlaTelemetryChannel(rawValue: rawChannel) ?? .unconfigured
    ...
    var defaultParameters: [String: String] {
        [
            "imla.channel": channel.rawValue,
            "imla.bundle_id": bundleID,
        ]
    }
