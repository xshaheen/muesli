...
final class AppDelegate: NSObject, NSApplicationDelegate, NSMenuItemValidation {
    private var controller: ImlaController?
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        do {
            ...
            let controller = ImlaController(runtime: runtime)
    ...
    func application(
        ...
        fputs("[imla-native] registered for remote notifications\n", stderr)
    }
    ...
    func application(
        ...
        fputs("[imla-native] failed to register for remote notifications: \(error)\n", stderr)
    }
...
enum UpdateFailureGuidance {
    ...
    static let message = """
    Please quit Imla, reopen it from Applications, and try the update once more.

    If this keeps happening, download the latest DMG and replace Imla manually. This can happen when the local updater cannot finish preparing or replacing the app.
    """
