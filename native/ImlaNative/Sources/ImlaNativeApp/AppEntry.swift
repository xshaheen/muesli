...
/// ImlaNativeAppShell executable target. AppDelegate and the rest of the app
/// live in the ImlaNativeApp library so the executable can stay a minimal shell
/// that Xcode can wrap as a real Application product.
@MainActor
public enum ImlaAppEntry {
