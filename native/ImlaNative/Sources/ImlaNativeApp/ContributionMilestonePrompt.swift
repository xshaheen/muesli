...
enum ContributionMilestoneAction: String, CaseIterable {
    ...
    case tweetAboutImla = "tweet_about_imla"
    ...
    var supportURL: URL? {
        ...
        case .tweetAboutImla, .postOnLinkedIn:
            return nil
        }
    }
}
...
struct ContributionMilestonePrompt: Equatable, Identifiable {
    ...
    var message: String {
        switch kind {
        case .dictationWords:
            if !showGitHubStar && !showBuyMeCoffee && (showTweetAboutImla || showPostOnLinkedIn) {
                return "That is a serious pile of words. If Imla has been saving your fingers and your flow, sharing your milestone helps more people find it."
            }
            return "That is a serious pile of words. If Imla has been saving your fingers and your flow, a GitHub star or a coffee helps keep it moving."
        case .meetings:
            return "That is a lot of conversations turned into something useful. If Imla has been keeping your meetings in order, a GitHub star or a coffee helps keep it moving."
        }
    }
}

enum ContributionSocialShare {
    static let imlaURL = URL(string: "https://github.com/xshaheen/muesli")!
    ...
    static func message(wordCount: Int) -> String {
        "I've dictated \(formatCount(wordCount)) words with Imla. It's fast, open source, on-device, and free to use. Try it: \(imlaURL.absoluteString)"
    }
    ...
    static func linkedInURL(wordCount: Int) -> URL {
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "text", value: message(wordCount: wordCount)),
            URLQueryItem(name: "url", value: imlaURL.absoluteString),
            URLQueryItem(name: "shareUrl", value: imlaURL.absoluteString),
...
enum ContributionMilestonePolicy {
    ...
    static func prompt(
        ...
        let showTweetAboutImla = canShowSocialActions && !tweetClicked
        let showPostOnLinkedIn = canShowSocialActions && !linkedInClicked
        guard showGitHubStar || showBuyMeCoffee || showTweetAboutImla || showPostOnLinkedIn else {
            return nil
        }
        ...
        return ContributionMilestonePrompt(
            ...
            showTweetAboutImla: showTweetAboutImla,
