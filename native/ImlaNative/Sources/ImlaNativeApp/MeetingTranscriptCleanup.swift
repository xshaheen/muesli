...
enum MeetingTranscriptCleanup {
    ...
    private static let logger = Logger(subsystem: "com.xshaheen.imla", category: "meeting-cleanup")
    ...
    /// selection (KTD1, R10).
    ///
    /// No separate toggle: repair runs when the user told Imla the meeting is
