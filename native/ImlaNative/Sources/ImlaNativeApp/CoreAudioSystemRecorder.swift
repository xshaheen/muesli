...
final class CoreAudioSystemRecorder: SystemAudioCapturing, SystemAudioDiagnosticsProviding {
    ...
    private let deviceIOQueue = DispatchQueue(label: "com.xshaheen.imla.system-audio-tap.io", qos: .userInitiated)
    private let processingQueue = DispatchQueue(label: "com.xshaheen.imla.system-audio-tap")
    ...
    private let routeSignalQueue = DispatchQueue(label: "com.xshaheen.imla.system-audio-route-signal")
    ...
    private func startCapture() throws {
        ...
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("imla-system-audio", isDirectory: true)
    ...
    private func createTapAndAggregateDevice() throws {
        ...
        // output mixed to stereo, excluding Imla itself. The previous
        ...
        // crashed session still holds the stable UID (or another Imla
        ...
        var aggUID = "com.xshaheen.imla.system-audio-tap"
        ...
        if status != noErr || aggregateDeviceID == kAudioObjectUnknown {
            ...
            aggUID = "com.xshaheen.imla.system-audio-tap-fallback"
    ...
    static func makeAggregateDeviceDescription(tapUID: String, aggregateUID: String) -> NSDictionary {
        [
            kAudioAggregateDeviceNameKey: "Imla System Audio",
    ...
    static func cleanupStaleDevices() {
        ...
        for deviceID in devices {
            ...
            if (name.takeRetainedValue() as String) == "Imla System Audio" {
