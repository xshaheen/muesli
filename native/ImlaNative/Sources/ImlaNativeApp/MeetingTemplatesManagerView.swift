...
struct MeetingTemplatesManagerView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: ImlaTheme.spacing20) {
    ...
    private var customTemplateEditor: some View {
                ...
                TextField("Customer follow-up", text: $draftTemplateName)
                    ...
                    .overlay {
                        RoundedRectangle(cornerRadius: 6, style: .continuous)
                            .strokeBorder(
                                showNameValidationError ? ImlaTheme.danger.opacity(0.75) : .clear,
                                lineWidth: 1
                            )
                    }
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                TextEditor(text: $draftTemplatePrompt)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: ImlaTheme.cornerSmall, style: .continuous)
                            .strokeBorder(
                                showPromptValidationError ? ImlaTheme.danger.opacity(0.75) : ImlaTheme.surfaceBorder,
                                lineWidth: 1
                            )
                    )
        ...
        .padding(ImlaTheme.spacing12)
        .background(ImlaTheme.surfacePrimary.opacity(0.45))
