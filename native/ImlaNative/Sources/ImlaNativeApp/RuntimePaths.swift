    ...
    static func resolve() throws -> RuntimePaths {
        if let bundleResource = Bundle.main.resourceURL {
            return RuntimePaths(
                ...
                appIcon: bundleResource.appendingPathComponent("imla.icns"),
        ...
        for _ in 0..<8 {
            let candidate = searchURL.appendingPathComponent("assets/imla.icns")
        ...
        throw NSError(domain: "ImlaRuntime", code: 1, userInfo: [
