...
/// Portable import/export support for Imla's personal dictionary.
///
...
/// dictionary usable from both the app and `imla-cli` without duplicating
/// format handling.
public enum CustomWordDictionaryCodec {
    ...
    public enum Error: Swift.Error, Equatable, LocalizedError {
        ...
        public var errorDescription: String? {
            "The file is not a valid Imla dictionary."
        }
    }
